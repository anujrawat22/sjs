...
export function CTA() {
  return (
    <section className="relative py-32 bg-fixed bg-center bg-cover overflow-hidden" style={{ backgroundImage: "url(/12.png)" }}>
      ...
      <div className="max-w-5xl mx-auto px-4 relative z-10">
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 md:p-16 text-center shadow-2xl hover:shadow-[0_20px_50px_rgba(0,0,0,0.5)] transition-all duration-500 hover:-translate-y-1">
          ...
          <p className="text-xl md:text-2xl mb-12 text-slate-100 font-medium max-w-3xl mx-auto leading-relaxed drop-shadow-md">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
            {/* Button 1 */}
            <a href="https://wa.me/917417656633" target="_blank" rel="noopener noreferrer" className="group w-full md:w-auto bg-red-600 text-white px-8 py-4 rounded-xl font-bold flex items-center justify-center gap-3 hover:bg-red-700 transition-all duration-300 shadow-lg hover:shadow-red-600/30 hover:scale-105">
